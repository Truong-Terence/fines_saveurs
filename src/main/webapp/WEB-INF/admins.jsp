...
<div class="container">
    <h1 class="mt-5">Administrateurs</h1>
    <c:url value="/secured/add-admin" var="addAdmin" />
    <div class="col text-end">
        <a href="${pageContext.request.contextPath}/secured/add-admin" class="ms-auto">
...
<%--    <a href="${addAdmin}">Ajouter</a>--%>
    ...
    <table class="table table-striped">
        ...
        <c:set var="emptyAdminIds" value="" />
        <c:forEach var="emptyAdmin" items="${emptyAdmins}">
            <c:set var="emptyAdminIds" value="${emptyAdminIds},${emptyAdmin.id}" />
        </c:forEach>
        <c:forEach var="admin" items="${admins}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/secured/edit-admin?id=${admin.id}"><img src="/images/circum_edit.svg" alt="éditer"></a></td>
                </td>
                <td>
                    <c:if test="${fn:contains(emptyAdminIds, admin.id)}">
